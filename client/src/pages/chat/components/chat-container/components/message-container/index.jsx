...
const MessagesContainer = () => {
    ...
    const checkIfImage = (url) => {
        const imageRegex = /\.(jpeg|jpg|gif|png|bmp|svg|webp|tiff|ico|)$/i;
                        ...
                        {message.sender._id !== userInfo._id && (
                            <div className="flex items-center justify-start gap-3">
                                <Avatar className="h-8 w-8 rounded-full overflow-hidden">
                                    ...
                                    <AvatarFallback
                                        className={`uppercase h-8 w-8 rounded-full text-lg overflow-hidden flex items-center justify-center ${getColor(
                    ...
                    >
                        ...
                        >
                            {checkIfImage(message.fileUrl) ? (
                                ...
                                <div className="flex w-full break-words items-center justify-between gap-4">
    ...
    return (
        <div className=" flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65vw] lg:w-[70vw] xl:[80vw] w-full">
            ...
            {showImage && (
                <div className="fixed z-[1000] top-0 h-[100vh] w-[100vw] flex items-center justify-center backdrop-blur-lg flex-col">
                    <div>
                        <img
                            src={`${HOST}/${imageUrl}`}
                            alt={imageUrl}
