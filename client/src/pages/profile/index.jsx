        ...
        <div className="bg-[#1b1c24] h-[100vh] flex items-center justify-center  flex-col gap-10">
            <div className="flex flex-col gap-10 w-[80vw] md:w-max ">
                ...
                <div className="grid grid-cols-2 items-center">
                    <div
                        className="h-32 w-32 md:w-48 md:h-48 relative flex items-center justify-center p-5"
                    ...
                    >
                        ...
                        <input type="file" className=" hidden" onChange={handleImageChange} ref={fileInputRef} name="profile-image" accept=".png, .jpg, .jpeg, .svg, .webp"/>
                    </div>
                ...
                <div className=" w-full">
                    <Button
                        className=" h-16 w-full bg-purple-700 hover:bg-purple-900 text-lg text-white/60 hover:text-white transition-all duration-300"
                        onClick={saveChanges}
                    >
                        Save Changes
                    </Button>
